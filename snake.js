function init() {
    ...
    W = H = canvas.width = 700, canvas.height = 670
    ...
    snake = {
        ...
        updateSnake:function(){
            ...
            /*Write a logic that prevents sanke from going out*/
            var last_x = Math.round(W/cs)
            var last_y = Math.round(H/cs)

            if(this.cells[0].y < 0 || this.cells[0].x < 0 || this.cells[0].x > last_x || this.cells.y > last_y){
                game_over = true
            }
